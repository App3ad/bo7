...
function productListClicked(e) {
  ...
  var dialog = Ti.UI.createAlertDialog({
    ...
    message: 'Next payment: ' + Alloy.Globals.moment(item.properties.lastPaymentDate).add(parseInt(item.properties.periodNumber) * 2, item.properties.periodType).fromNow(),
    cancel: 0,
